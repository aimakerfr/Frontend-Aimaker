...
const SourcePanel: React.FC<SourcePanelProps> = ({ sources, onToggleSource, onDeleteSource, onOpenImportModal, onOpenUploadModal, hideImportButton = false, hideUploadButton = false }) => {
    const { t } = useLanguage();
    ...
    return (
        <div ref={panelRef} className="h-full flex flex-col bg-gradient-to-b from-gray-50/50 to-white border-r border-gray-200/70 relative overflow-hidden">
            ...
            <SourceList
                ...
                hideDeleteButton={hideUploadButton}
            />
