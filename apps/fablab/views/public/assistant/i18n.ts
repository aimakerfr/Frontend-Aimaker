...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    'config.uploadDesc': 'DOC, DOCX or TXT to enrich the context.',
    ...
    'preview.placeholder': 'Send a message to {title}...',
  ...
  fr: {
    ...
    'config.uploadDesc': 'DOC, DOCX ou TXT pour enrichir le contexte.',
    ...
    'preview.placeholder': 'Envoyer un message à {title}...',
  ...
  es: {
    ...
    'config.uploadDesc': 'DOC, DOCX o TXT para enriquecer el contexto.',
    ...
    'preview.placeholder': 'Enviar un mensaje a {title}...',
