...
const PromptBodySectionComponent: React.FC<Props> = ({ initialValue, onSave, onBodyChange, saving = false, disabled = false, status = 'idle' }) => {
  ...
  return (
    <div className="relative group w-full flex flex-col">
      <label className="block text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">CORPS DU PROMPT</label>
      <div className="relative w-full">
        <textarea
          ...
          placeholder="Écrivez ici le contenu de votre prompt..."
        ></textarea>
